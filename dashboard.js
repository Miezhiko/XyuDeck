...
var $author$project$Dashboard$view = function (_v0) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($elm$html$Html$Attributes$attribute, 'src', 'https://www.youtube.com/embed/SQ7mTBToqOY?autoplay=1'),
								$elm$html$Html$Attributes$width(800),
								$elm$html$Html$Attributes$height(600),
								A2($elm$html$Html$Attributes$style, 'overflow', 'auto'),
								A2($elm$html$Html$Attributes$style, 'border', '5px ridge red')
							]),
						_List_Nil)
					]))
			]));
};
var $author$project$Dashboard$main = $elm$browser$Browser$sandbox(
	{at: 'Xyutter', aB: $author$project$Dashboard$update, aC: $author$project$Dashboard$view});
